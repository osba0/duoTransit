...
class DossierRessource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            "terminal_retour"           => $this->terminalRetour,
            "nomNavire"                 => $this->nomNavire,
            "dateDepart"                => Carbon::parse($this->dateDepart)->format('d/m/Y'),
            "dateArrivee"               => Carbon::parse($this->dateArrivee)->format('d/m/Y'),
