...
class DossierRessource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            "dateDepart"                => ($this->dateDepart=='' || $this->dateDepart=='0000-00-00') ?'-':Carbon::parse($this->dateDepart)->format('d/m/Y'),
            "dateArrivee"               => ($this->dateArrivee=='' || $this->dateArrivee=="0000-00-00") ?'-':Carbon::parse($this->dateArrivee)->format('d/m/Y'),
