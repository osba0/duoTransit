<div class="image d-flex align-items-center">
    ...
    <div class="pull-right mr-3">
        ...
        <span class="badge text-uppercase {{Auth::user()->roles[0]=='root'?'badge-danger ':''}} {{Auth::user()->roles[0]=='client'?'badge-warning ':''}} {{Auth::user()->roles[0]=='user'?'badge-secondary ':''}} {{Auth::user()->roles[0]=='admin' || Auth::user()->roles[0]=='consultation' || Auth::user()->roles[0]=='auxiliaire' ?'badge-info ':'badge-dark '}}">{{Auth::user()->roles[0]}}</span>
    </div>
