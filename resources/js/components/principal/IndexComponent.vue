       ...
       <div class="row">
            <div class="col-md-12 pt-5">
                <div class="text-left pb-2 border-bottom  h4 mb-2">
                    ...
                    {{ clientsAuth.length > 0 ? 'Client(s) supervisé(s) ' : 'Choisir une société' }} 
        ...
        <div class="row">
            <div class="col-md-12">
                <template v-if="!clients.data || !clients.data.length">    
                    <span class="badge badge-warning p-2 ">Aucun client disponible!</span>
                </template>
                        ...
                        <div class="d-flex flex-column justify-content-center align-items-center h-100 w-100">
                            <div class="logoCl text-center p-1 position-relative" style="background: transparent;">
                                <template v-if = "client.logo">
                                   <img :src="'/images/logo/'+client.logo" style="height: 80px" class="elevation-2 border bg-white inline-block" alt="User Image">
                                </template>
                                <template v-else>
                                  No image
                                </template>
