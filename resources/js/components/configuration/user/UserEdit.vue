    ...
    data() {
        return {
            ...
            user: {
                ...
                roles: (this.data.roles === null) ? '' : this.data.roles[0],
                status: this.data.status,
                banned_at: this.data.banned_at != null,
                banned_reason: this.data.banned_reason
            }
        }
    },
    methods:{
        updateUser(e) {
            axios.put(`/user/${this.user.id}`, this.user)
                .then(response => {
                    ...
                    window.open(`/user/${this.user.id}/`, '_self');
                })
                .catch(error => {
                    let message = '';
