                      ...
                      <tr v-for="empotage in empotages.data">
                        ...
                        <td class="p-2 align-middle">
                         ...
                         <td class="p-2 text-right">
                            <a title="Editer" :href="'/empotage/'+idClient+'/'+empotage.reference+'/'+empotage.typeCommandeID+'/'+empotage.id" class="btn bg-white m-1 border m-1">
                                    <i class="fa fa-pencil" aria-hidden="true"></i> Saisir
                            </a>
                                 <a title="Editer" href="#" class="btn m-1 border m-1 bg-white" v-on:click="editEmpotage(empotage)" data-toggle="modal" data-target="#newEmpotage">
    ...
    export default {
        ...
        methods : { 
            ...
            getEmpotage(page = 1){
                ...
                axios.get('/api/empotage/list?page=' + page + "&paginate=" + this.paginate).then(response => {
