             ...
             <tbody>
                   <template v-if="!chargement.data || !chargement.data.length">    
                     <tr class="bg-white">
                      ...
                      <tr v-for="char in chargement.data" :key="chargement.numDossier" class="bg-white">
                        ...
                        <td class="p-2 align-middle">
                         ...
                         <td class="p-2 text-right">
                            <!--a :href="'/prechargement/'+char.numDossier">Précharger</a>
                            <a href="#">Empotage</a>
                            <a title="Chargement" class="btn m-1 btn-circle border btn-circle-sm" :href="'/chargement/'+idClient+'/'+char.numDossier">
                               <i class="fa fa-database "></i>
                            </a-->
                          
                             <a title="Editer" href="#" class="btn m-1 btn-circle border btn-circle-sm m-1" v-on:click="editChargement(char)" data-toggle="modal" data-target="#newChargement">
	...
	export default {
        ...
        methods : { 
            getChargement(page = 1){
                axios.get('/api/chargement/list?page=' + page + "&paginate=" + this.paginate).then(response => {
            ...
            createDossier(){
                ...
                axios.post('/api/chargement/save', {
